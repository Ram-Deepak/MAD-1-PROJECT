...
def profile(username):
    ...
    blobToPhoto(profile.photo, '/home/ram/Desktop/IIT-M/DIPLOMA/MAD-1-PROJECT/static/images/img.jpeg')
    if profile.posts==0:
...
def show_own_post(username, post_id):
    ...
    blobToPhoto(post.image,'/home/ram/Desktop/IIT-M/DIPLOMA/MAD-1-PROJECT/static/images/post.jpg')
